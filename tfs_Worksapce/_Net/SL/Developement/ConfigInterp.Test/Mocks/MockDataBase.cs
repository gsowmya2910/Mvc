// ----------------------------------------------------------------------
// <copyright file="MockDataBase.cs" company="CoreLink">
...
namespace ConfigInterp.Test.Mocks
{
    ...
    [SuppressMessage("ReSharper", "UnusedAutoPropertyAccessor.Local", Justification = "Test Mock")]
    [ExcludeFromCodeCoverage]
    internal class MockDataBase : ISimpleInquire
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="MockDataBase"/> is success.
        /// </summary>
        /// <value>
