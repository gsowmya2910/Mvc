// ----------------------------------------------------------------------
// <copyright file="InquireInterpRequest.cs" company="CoreLink">
...
namespace ConfigInterp.Contracts.MessageContracts
{
    ...
    public class InquireInterpRequest : RequestHeaderBase
    {
        /// <summary>
        ...
        /// </value>
        [MessageBodyMember]
        public InquireInterpNarrativeData Data { get; set; }
    }
}